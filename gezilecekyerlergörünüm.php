...
if ($_POST){
    ...
    $sorgu = $baglan->query("delete from gezilecekyerler ");
    $sorgu = $baglan->query("insert into gezilecekyerler (aciklama) values ('$aciklama')");
    if ($sorgu){
        echo "<script> window.location.href='gezilecekyerler.php'; </script>";
    }

}
$sorgu = $baglan->query("select * from gezilecekyerler");
...
<body>
     <div class="konteynır" style="background: url(bursa_resimleri_7.jpg);
        height: 100vh;
